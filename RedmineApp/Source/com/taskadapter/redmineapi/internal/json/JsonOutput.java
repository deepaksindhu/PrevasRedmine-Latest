...
public class JsonOutput {
	 ...
	 *             if io error occurs.
	 */
	public static void addIfNotNull(JSONStringer writer, String field,
	 ...
	 *             if io error occurs.
	 */
	public static void addIfNotNull(JSONStringer writer, String field, Float value)
			throws JSONException {
		if (value == null)
			return;
		writer.key(field);
	 ...
	 *             if io error occurs.
	 */
	public static void add(JSONStringer writer, String field,
 Date value,
	 ...
	 *             if io error occurs.
	 */
	public static <T> void addIfNotNull(JSONStringer writer, String field,
	 ...
	 */
	public static <T> void addArrayIfNotNull(JSONStringer writer, String field,
	 ...
	 *            single object writer.
	 */
	public static <T> void addArrayIfNotEmpty(JSONStringer writer, String field,
			Collection<T> items, JsonObjectWriter<T> objWriter)
			throws JSONException {
	...
	private static <T> void addCollection(JSONStringer writer, String field,
			Collection<T> items, JsonObjectWriter<T> objWriter)
			throws JSONException {
		writer.key(field);
		writer.array();
