...
public class RedmineJSONBuilder {
	...
	private static JsonObjectWriter<Tracker> TRACKER_WRITER = new JsonObjectWriter<Tracker>() {
		@Override
		public void write(JSONStringer writer, Tracker object)
	...
	public static JsonObjectWriter<Project> PROJECT_WRITER = new JsonObjectWriter<Project>() {
		@Override
		public void write(JSONStringer writer, Project object)
				throws JSONException {
	...
	public static JsonObjectWriter<Issue> ISSUE_WRITER = new JsonObjectWriter<Issue>() {
		@Override
		public void write(JSONStringer writer, Issue object) throws JSONException {
	...
	public static JsonObjectWriter<User> USER_WRITER = new JsonObjectWriter<User>() {
		@Override
		public void write(JSONStringer writer, User object) throws JSONException {
	...
	public static JsonObjectWriter<IssueRelation> RELATION_WRITER = new JsonObjectWriter<IssueRelation>() {
		@Override
		public void write(JSONStringer writer, IssueRelation object)
				throws JSONException {
	...
	public static JsonObjectWriter<IssueCategory> CATEGORY_WRITER = new JsonObjectWriter<IssueCategory>() {
		@Override
		public void write(JSONStringer writer, IssueCategory object)
				throws JSONException {
	...
	public static JsonObjectWriter<Version> VERSION_WRITER = new JsonObjectWriter<Version>() {
		@Override
		public void write(JSONStringer writer, Version object)
				throws JSONException {
	...
	public static JsonObjectWriter<TimeEntry> TIME_ENTRY_WRITER = new JsonObjectWriter<TimeEntry>() {
		@Override
		public void write(JSONStringer writer, TimeEntry object)
				throws JSONException {
	...
	public static JsonObjectWriter<Attachment> UPLOAD_WRITER = new JsonObjectWriter<Attachment>() {
		@Override
		public void write(JSONStringer writer, Attachment object)
				throws JSONException {
	...
	public static JsonObjectWriter<Membership> MEMBERSHIP_WRITER = new JsonObjectWriter<Membership>() {
		@Override
		public void write(JSONStringer writer, Membership object)
				throws JSONException {
	 ...
	 *             if IO error occurs.
	 */
	public static void writeProject(JSONStringer writer, Project project)
	...
	static void writeTimeEntry(JSONStringer writer, TimeEntry timeEntry)
			throws JSONException {
	 ...
	 *             if error occurs.
	 */
	static void writeTracker(JSONStringer writer, Tracker tracker)
			throws JSONException {
		writer.key("id");
	...
	static void writeRelation(JSONStringer writer, IssueRelation relation)
			throws JSONException {
	...
	static void writeVersion(JSONStringer writer, Version version)
			throws JSONException {
	...
	public static <T> String toSimpleJSON(String tag, T object,
		...
		final JSONStringer jsWriter = new JSONStringer();
		try {
			jsWriter.object();
			jsWriter.key(tag);
			jsWriter.object();
	...
	public static void writeProject(Project project, final JSONStringer writer)
			throws JSONException {
	...
	public static void writeCategory(IssueCategory category,
			final JSONStringer writer) throws JSONException {
		writer.key("id");
	...
	public static void writeUpload(JSONStringer writer, Attachment attachment)
			throws JSONException {
	...
	public static void writeMembership(JSONStringer writer, Membership membership)
			throws JSONException {
	...
	private static void writeCustomFields(JSONStringer writer,
	 ...
	 *             if io error occurs.
	 */
	public static void addIfNotNullFull(JSONStringer writer, String field,
	 ...
	 *             if io error occurs.
	 */
	public static void addFull(JSONStringer writer, String field, Date value)
			throws JSONException {
		final SimpleDateFormat format = RedmineDateUtils.FULL_DATE_FORMAT.get();
	 ...
	 *             if io error occurs.
	 */
	public static void addIfNotNullShort(JSONStringer writer, String field,
			Date value) throws JSONException {
     ...
     *             if io error occurs.
     */
    public static void addIfNotNullShort2(JSONStringer writer, String field,
            Date value) throws JSONException {
     ...
     *             if io error occurs.
     */
    public static void addShort2(JSONStringer writer, String field, Date value)
            throws JSONException {
